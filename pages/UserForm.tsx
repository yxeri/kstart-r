    ...
    <div className={styles.formBackground}>
      <div className={styles.formContainer}>
        ...
        <form id='form' noValidate onSubmit={handleSubmit} >
          ...
          <label>
            <p>Lastname:</p>
            <input type="text" name="lastName" onChange={handleChange} value={formValue.lastName} /> 
          </label>
          <label>
            <p>Phonenumber:</p>
            <input type="text" name="phoneNumber" onChange={handleChange} value={formValue.phoneNumber} />
          </label>
          <label>
            <p>E-mail:</p>
            <input type="email" name="email" onChange={handleChange} value={formValue.email.trim()} />
          </label>
